...
import circleOutlineImg from "./images/circle-outline.svg";
import checkCircleOutlineImg from "./images/check-circle-outline.svg";
...
function allTasksDisplay(myTasks) {
  ...
  for (let i = 0; i < myTasks.length; i++) {
    ...
    checkbox.setAttribute("src", circleOutlineImg);
    ...
    if (myTasks[i].done === "incomplete") {
      ...
      checkbox.setAttribute("src", checkCircleOutlineImg);
